...
import { Vault } from './utils/lib/Vault';
...
// eslint-disable-next-line class-methods-use-this
  private initGlobals(): void {
    ...
    customGlobal.vault = {};
    [{ serviceName: 'wordle', credentialName: 'spectrumWordle' }]
      .map((vaultDetails) => {
        const { serviceName, credentialName } = vaultDetails;
        customGlobal.vault[`${serviceName}`] = {};
