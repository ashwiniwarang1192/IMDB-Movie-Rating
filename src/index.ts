...
import { isStage } from './modules/common/constants';

if (process.env.NODE_ENV?.toLowerCase() === 'production') {
  // eslint-disable-next-line global-require, @typescript-eslint/no-unused-vars, @typescript-eslint/no-var-requires, @typescript-eslint/no-unsafe-assignment
...
function onListening(): void {
  const addr: TAddress = server.address();
